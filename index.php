...
<head>
  ...
  <!--Bootsrap 4 CDN-->
    ...
    <!--Logos para usuario y contraseña y redes sociales-->
    ...
    <div class='card'>
      ...
      <div class='card-body'>
        <form method='post' action='index.php'>
          ...
          <div class='input-group form-group'>
            ...
            <input type='password' class='form-control' placeholder='Password' name='txtContrasena' required>
          </div>
      ...
      <div class='card-footer'>
        <div class='d-flex justify-content-center links'>
          No recuerdas tu contraseña?<a href='#'></a>
        </div>
